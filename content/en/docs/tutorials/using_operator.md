---
title: "Using the ArkMQ Operator"  
...
The [ArkMQ](https://github.com/arkmq-org) Operator is a powerful tool that allows you to configure and
...
instance running on your laptop will do fine. The ArkMQ Operator can also run in an Openshift cluster environment such as [CodeReady Containers](https://developers.redhat.com/products/codeready-containers/overview).
...
```
The _address_queue.yaml_ is another CR supported by the ArkMQ Operator. Its content is shown below:
```yaml
...
* [ArkMQ Github Repo](https://github.com/arkmq-org)
